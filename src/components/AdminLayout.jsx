...
const menuItems = [
    ...
    { text: 'Register Student', icon: <PersonAdd />, path: '/dashboard/admin/student-registration' },
    { text: 'Manage Events', icon: <Event />, path: '/events' },
    { text: 'Manage Complaints', icon: <Description />, path: '/complaints/admin' },
    { text: 'Skill Exchange', icon: <School />, path: '/skill-exchange/admin' },
    { text: 'Poll Management', icon: <Poll />, path: '/polls/admin' },
];
    ...
    const drawerContent = (
        <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column', bgcolor: 'background.paper' }}>
            <Toolbar sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', px: [1] }}>
                <Typography variant="h6" color="primary" sx={{ fontWeight: 'bold', ml: 2, display: 'flex', alignItems: 'center', gap: 1 }}>
        ...
        <Box sx={{ display: 'flex' }}>
            ...
            >
                <Toolbar>
                    ...
                    <Box sx={{ flexGrow: 1 }} />
                    <Typography variant="body2" sx={{ mr: 2, color: 'text.secondary' }}>Administrator</Typography>
                    <IconButton
                        size="large"
